...
class LFUCache(BaseCaching):
    ...
    def put(self, key, item):
        """Add an item to the cache, and apply LFU + LRU replacement policy when limit exceeded."""
    ...
    def get(self, key):
        """Retrieve an item from the cache by key, updating frequency and recency."""
    ...
    def _discard_lfu_item(self):
        """Remove the least frequently used (and least recently used in case of tie) item."""
